    ...
    <div>
        <b-card title="Agregar cliente">
            <b-form @submit.prevent="onSubmit">
                <b-row class="my-1">
                    <label for="input-name" class="col-md-5">Nombre</label>
                    <div class="col-md-7">
                        <b-form-input 
                            id="input-name"
                            v-model="form.name"
                ...
                <b-row class="my-1">
                    <label for="input-email" class="col-md-5">Correo electrónico</label>
                    <div class="col-md-7">
                        <b-form-input 
                            id="input-email"
                            v-model="form.email"
                ...
                <b-row class="my-1">
                    <label for="input-direccion" class="col-md-5">Dirección</label>
                    <div class="col-md-7">
                        <b-form-input 
                            id="input-direccion"
                ...
                <b-row class="my-1">
                    <label for="input-descuento" class="col-md-5">Descuento</label>
                    <div class="col-md-7">
                        <b-form-input 
                            id="input-descuento"
                ...
                <b-row class="my-1">
                    <label for="input-condiciones_pago" class="col-md-5">Condiciones de pago</label>
                    <div class="col-md-7">
                        <b-form-input 
