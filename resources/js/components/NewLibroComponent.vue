        ...
        <div class="card col-md-8">
            <div class="card-body">
                <b-form @submit.prevent="onSubmit">
                    <!-- <b-row class="my-1">
                        <label align="right" for="input-clave" class="col-md-5">Clave</label>
                        <div class="col-md-7">
                            <b-form-input 
                                id="input-clave"
                                v-model="form.clave"
                    ...
                    <b-row class="my-1">
                        <label align="right" for="input-titulo" class="col-md-5">Titulo</label>
                        <div class="col-md-7">
                            <b-form-input 
                                id="input-titulo"
                                v-model="form.titulo"
                    ...
                    <b-row class="my-1">
                        <label align="right" for="input-ISBN" class="col-md-5">ISBN</label>
                        <div class="col-md-7">
                            <b-form-input 
                                id="input-ISBN"
                                v-model="form.ISBN" 
                    ...
                    <b-row class="my-1">
                        <label align="right" for="input-autor" class="col-md-5">Autor</label>
                        <div class="col-md-7">
                            <b-form-input 
                                id="input-autor"
                                v-model="form.autor" 
                    ...
                    <b-row class="my-1">
                        <label align="right" for="input-editorial" class="col-md-5">Editorial</label>
                        <div class="col-md-7">
                            <b-form-input 
                                id="input-editorial"
                    ...
                    <b-row class="my-1">
                        <label align="right" for="input-edicion" class="col-md-5">Edición</label>
                        <div class="col-md-7">
                            <b-form-input 
                                id="input-edicion"
                    ...
                    <b-row class="my-1">
                        <label align="right" for="input-costo_unitario" class="col-md-5">Costo unitario</label>
                        <div class="col-md-7">
                            <b-form-input 
