<template>
    <div>
        ...
        <div v-if="mostrarEA">
            <b-row>
                <b-col sm="3">
                    <h4 style="color: #170057">{{ agregar ? 'Registrar' : 'Modificar' }} entrada</h4>
                </b-col>
            ...
            <b-row>
                ...
                <b-col sm="5">
                    ...
                    <b-form-select v-model="entrada.editorial" autofocus :disabled="load" :state="stateE" :options="optionsEdit"></b-form-select>
                </b-col>
                <b-col sm="3" align="right">
