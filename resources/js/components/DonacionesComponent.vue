        ...
        <div v-if="listadoDonaciones">
            ...
            <b-row>
                ...
                <b-col sm="3" class="text-right">
                    <b-button v-if="role_id == 2" variant="success" @click="registrarDonacion()">
            ...
            <div v-if="regalos.length > 0">
                ...
                <b-table 
                    ...
                    <template slot="entregado_por" slot-scope="row">
                        <b-button 
                            variant="success" 
                            v-if="row.item.entregado_por === null && role_id === 3"
                            :disabled="load"
        ...
        methods: {
            ...
            guardarDonacion(){
                if(this.regalo.plantel.length > 4){
                    this.state = true;
                    this.load = true;
                    axios.post('/guardar_donacion', this.regalo).then(response => {
                        this.load = false;
