            ...
            <main class="py-4">
                ...
                <table cellpadding="100">
                    <tr>
                        ...
                        <!-- <img src="../../../public/img/Globo.png" height="100" width="100" align="right" ></th> -->
                    ...
                    <tr>
                        ...
                        <td class="sinBorde" ></td>
                        <td class="sinBorde" id="contacto">REMISION No.</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="sinBorde" id="tdder">
                            <p align="center">{{ $remision->created_at->format('d/m/Y') }}</p>
                        </td>
