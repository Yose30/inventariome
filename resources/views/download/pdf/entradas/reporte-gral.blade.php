                    ...
                    @else
                        ...
                        @foreach($entradas as $entrada)
                            <tr>
                                ...
                                <td class="bordesVer" style="width:12%" id="tdcent">{{ number_format($entrada->unidades, 2) }}</td>
                                <td class="bordesVer" style="width:12%" id="tdder">${{ number_format($entrada->total, 2) }}</td>
                                <td class="bordesVer" style="width:12%" id="tdder">${{ number_format($entrada->total_pagos, 2) }}</td>
                                <td class="bordesVer" style="width:12%" id="tdder">${{ number_format($entrada->total - $entrada->total_pagos, 2) }}</td>
                                <td class="bordesVer" style="width:12%" id="tdcent">{{ $entrada->created_at->format('Y-m-d') }}</td>
                            </tr>
                        @endforeach  
                        <tr>
                            <td class="sinBorde"></td><td class="sinBorde"></td>
