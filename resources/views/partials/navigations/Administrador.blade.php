<li>
	<a class="nav-link" href="{{ route('administrador.remisiones') }}">{{ __("Remisiones") }}</a>
</li>
<li>
	<a class="nav-link" href="{{ route('administrador.vendidos') }}">{{ __("Vendidos") }}</a>
</li>
<li>
...
<li>
	<a class="nav-link" href="{{ route('administrador.adeudos') }}">{{ __("Adeudos") }}</a>
</li>
<li>
